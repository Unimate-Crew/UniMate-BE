...
export class FindMySalesResponseDto {
  @ApiProperty({
    description: '판매내역 목록',
    type: [MySalesItemDto],
  })
  contents: MySalesItemDto[];
  ...
  constructor(contents: MySalesItemDto[], hasNext: boolean) {
  ...
  ): FindMySalesResponseDto {
    const response = new FindMySalesResponseDto(
