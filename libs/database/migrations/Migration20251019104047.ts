...
export class Migration20251019104047 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table \`update_popup\` drop column \`min_version\`;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table \`update_popup\` add \`min_version\` varchar(255) not null;`);
  }
