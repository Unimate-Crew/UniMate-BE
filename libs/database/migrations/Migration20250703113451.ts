...
export class Migration20250703113451 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table \`product_image\` change \`image_url\` \`image_key\` varchar(255) not null;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table \`product_image\` change \`image_key\` \`image_url\` varchar(255) not null;`);
  }
