...
export class Migration20250822141139 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table \`user\` add \`price_changed_notification_enabled\` tinyint(1) not null default true, add \`sale_ended_notification_enabled\` tinyint(1) not null default true;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table \`user\` drop column \`price_changed_notification_enabled\`, drop column \`sale_ended_notification_enabled\`;`);
  }
