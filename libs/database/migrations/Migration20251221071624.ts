...
export class Migration20251221071624 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table \`like\` modify \`updated_at\` datetime not null;`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table \`like\` modify \`updated_at\` datetime not null default CURRENT_TIMESTAMP;`);
