...
export class Migration20260118110942 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table \`conversation_message\` modify \`sender_id\` int null;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table \`conversation_message\` modify \`sender_id\` int not null;`);
  }
